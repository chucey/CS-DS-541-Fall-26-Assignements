...
def train_softmax_classifier(train_images, train_labels, val_images, val_labels,
    ...
    wandb.init(
        ...
        project="cs541-hw2-fashion-mnist3",
        #defining group
        group="hyperparam_search",
        #define tag
        tags=["lr sweep"],
        config={
    ...
    for epoch in range(nepochs):
        ...
        #adding train performance
        train_cost=cross_entropy_loss(W,b,train_images,train_labels) #loss
        train_acc=compute_accuracy(W,b,train_images,train_labels) #accuracy
...
if __name__ == "__main__":
    ...
    #problem 3) part 5- to loop over all hyperparams
    learning_rates=[1e-5, 1e-1, 1e-2, 1e-4, 1e-3, 1e-7] 

    batch_sizes=[2,4,8, 32,128,256, 512, 64 ,16 ]
